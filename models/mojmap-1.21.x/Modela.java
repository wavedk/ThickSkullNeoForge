	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_r1 = body
				.addOrReplaceChild("body_r1",
						CubeListBuilder.create().texOffs(52, 0).addBox(-2.0F, 2.0F, -8.0F, 4.0F, 6.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 6.0F, 1.0F, 3.1416F, 0.0F, 0.0F));
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						...
						.addBox(-5.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(22, 0)
		...
		PartDefinition leg0 = body.addOrReplaceChild("leg0", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-4.0F, 2.0F, 5.0F, 0.0F, 0.3491F, 0.0F));

		PartDefinition leg0_r1 = leg0.addOrReplaceChild("leg0_r1",
				CubeListBuilder.create().texOffs(0, 16).addBox(-6.0F, -12.0F, 5.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leg1_r1 = leg1.addOrReplaceChild("leg1_r1",
				CubeListBuilder.create().texOffs(0, 16).mirror()
						.addBox(2.0F, -12.0F, 5.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition leg2 = body.addOrReplaceChild("leg2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-4.0F, 2.0F, -8.0F, 0.0F, -0.3491F, 0.0F));

		PartDefinition leg2_r1 = leg2.addOrReplaceChild("leg2_r1",
				CubeListBuilder.create().texOffs(0, 16).addBox(-6.0F, -12.0F, -7.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-12.0F, 4.0F, 6.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition leg3 = body.addOrReplaceChild("leg3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.0F, 2.0F, -8.0F, 0.0F, 0.3491F, 0.0F));

		PartDefinition leg3_r1 = leg3.addOrReplaceChild("leg3_r1",
				CubeListBuilder.create().texOffs(0, 16).mirror()
						.addBox(2.0F, -12.0F, -7.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(12.0F, 4.0F, 6.0F, 0.0F, 0.0F, -1.5708F));
