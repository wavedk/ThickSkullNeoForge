package net.mcreator.thickskull;
...
import net.mcreator.thickskull.init.ThickskullneoforgeModTabs;
import net.mcreator.thickskull.init.ThickskullneoforgeModMenus;
import net.mcreator.thickskull.init.ThickskullneoforgeModItems;
...
@Mod("thickskullneoforge")
public class ThickskullneoforgeMod {
	public static final Logger LOGGER = LogManager.getLogger(ThickskullneoforgeMod.class);
	public static final String MODID = "thickskullneoforge";

	public ThickskullneoforgeMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ThickskullneoforgeModItems.REGISTRY.register(modEventBus);
		ThickskullneoforgeModEntities.REGISTRY.register(modEventBus);
		ThickskullneoforgeModTabs.REGISTRY.register(modEventBus);
		ThickskullneoforgeModVariables.ATTACHMENT_TYPES.register(modEventBus);
		ThickskullneoforgeModMenus.REGISTRY.register(modEventBus);
