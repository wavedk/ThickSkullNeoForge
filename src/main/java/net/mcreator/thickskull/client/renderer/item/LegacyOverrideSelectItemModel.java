package net.mcreator.thickskull.client.renderer.item;
...
public class LegacyOverrideSelectItemModel implements ItemModel {
	...
	public static void registerItemModelTypes(RegisterItemModelsEvent event) {
		event.register(ResourceLocation.parse("thickskullneoforge:legacy_overrides"), LegacyOverrideSelectItemModel.Unbaked.MAP_CODEC);
	}
}